...

{
    ...
    // myDiv3.insertAdjacentElement("beforebegin", myDiv4); // inserta myDiv4 antes de la etiqueta de apertura de myDiv3
    myDiv3.insertAdjacentElement("afterbegin", myDiv4); // inserta myDiv4 dentro de myDiv3, antes de su primer hijo
    // myDiv3.insertAdjacentElement("beforeend", myDiv4); // inserta myDiv4 dentro de myDiv3, después de su último hijo
    // myDiv3.insertAdjacentElement("afterend", myDiv4); // inserta myDiv4 después de la etiqueta de cierre de myDiv3

    myDiv3.appendChild(myDiv4); // otra forma de insertar myDiv4 dentro de myDiv3, después de su último hijo

    myDiv3.insertAdjacentHTML("afterbegin", "<p>Hola soy un párrafo insertado con insertAdjacentHTML</p>"); // añade un párrafo al principio de myDiv3
    myDiv3.insertAdjacentElement("beforeend", "Hola");  // añade texto al final de myDiv3
