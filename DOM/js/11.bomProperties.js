...

{
    ...
    // window.history.back(); // Mueve una página atrás en el historial
    // window.history.forward(); // Mueve una página adelante en el historial
    // window.history.go(1); // Mueve n páginas en el historial, positivo adelante, negativo atrás
    // window.history.go(-1); 
